...
local_time_as_gmt_string(LocalTime) ->
    time_to_string(hd(calendar:local_time_to_universal_time_dst(LocalTime)),"GMT").
...
is_modified_p(FI, UTC_string) ->
	...
	UTC ->
	    ...
	    MtimeUTC = hd(calendar:local_time_to_universal_time_dst(Mtime)),
	    MtimeUTC > UTC
    end.
